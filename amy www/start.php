    ...
    <body onload="loaded()">
        ...
        <nav class="navigation">
            ...
            <ul>
                ...
                <li><a href="index.php" onclick="an()">Log Out
        ...
        <div class="container">
            <div class="layer layer1 active">
                <div class="home main">
                    ...
                    <div class="content-for-home">
                        ...
                        <h1 align="center">Anshul RAj & Brothers</h1>
                        <div class="social-icons">
                            ...
                            <div class="s-icon">
                                <a href="mailto:braj70901@gmail.com">
                        ...
                        <div class="side-nav">
                            ...
                            >
                                <span class="w">W</span>
                                <span class="tooltip">Brothers:)</span>
                            </button>
                            <button onclick="services(); animate6.play();">
                                <span class="w">W</span>
                                <span class="tooltip"> Ritik kumar:) </span>
                            </button>
                            ...
                            <button onclick="blog()">
                                <span class="w">W</span>
                                <span class="tooltip"> Anshul Rajpoot:) </span>
                            </button>
                            <button onclick="contact(); animate5.play()">
                                <span class="w">W</span>
                                <span class="tooltip"> Rahul Rajpoot :) </span>
                            </button>
                        </div>
                    ...
                    <div class="about_container">
                        ...
                        <div class="experience">
                            ...
                            <div class="cover">
                                ...
                                <i class="date">Sep 2022 - Present</i>
            ...
            <div class="layer layer3">
                <div class="services main">
                    ...
                    <div class="hero">
                        ...
                        <p class="hero-text">
                            Brothers is an excellent web designer and faultless
                    ...
                    <div class="capabilities right">
                        <p class="c_content">
                            ...
                            With a designers eye for details, Brothers is
            ...
            <div class="layer layer5">
                <div class="testimonial">
                    <h1>
                        <span>GLA University is my feture......</span>
                    </h1>
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="resources/img/bg1.png" alt="" />
                                <h4>Anshul Razz:)</h4>
                                <div class="rating">
                                    <label>&starf;</label>
                                    <label>&starf;</label>
                                ...
                                <p>
                                    <span>&ldquo;</span>
                                    Brothers is an excellent web designer and
                ...
                <div class="contact_us">
                    ...
                    <address class="info_container">
                        <div class="info info1">
                            ...
                            <a href="tel:+917983099190">917983099190+</a>
                        </div>
                        <div class="info info2">
                            <i class="fas fa-home"></i>
                            <span class="iname">Address</span>
                            <a
                                href="https://www.google.com/maps/place/Ritik+Razzz/@27.6487636,78.8059104,18.68z/data=!4m8!1m2!2m1!1snaugoan++amanpur+kasganj+up!3m4!1s0x397505669b34c2b5:0x3f9016fe88265662!8m2!3d27.6487674!4d78.8075769"
                            >
                                <h3>Ritik Razz's House</h3>
                                <span>Naugaon kasganj</span><br />
                                <span>UP, INDIA</span>
                            </a>
                        </div>
                        <div class="info info3">
                            ...
                            <a href="mailto:anshul.kumar_bca22@gla.ac.in"
                                >anshul.kumar_bca22@gla.ac.in</a
                            >
                            <a href="mailto:braj70901@gmail.com"
                                >braj70901@gmail.com</a
                            >
                        </div>
                    </address>
